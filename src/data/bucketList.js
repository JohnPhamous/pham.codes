/**
 * {
 *  name: string, coupled with url
 *  url: string
 *  progress: string
 *  _html: string, an override for what's rendered
 *  isDone: boolean
 * }
 */
export default [
  ...
  },
  {
    ...
    progress: '1,712/13,856 mature Anki cards',
    url: null,
    _html: null,
    isDone: false,
  },
  ...
  {
    name:
      'Work for a non-profit organization for a year on sustainability efforts',
    progress: null,
    url: null,
    _html: null,
    isDone: false,
  ...
  {
    name: 'Teach high school students or college freshmen',
    progress: null,
    url: null,
    _html: null,
    isDone: false,
